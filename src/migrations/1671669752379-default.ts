...
export class default1671669752379 implements MigrationInterface {
    name = 'default1671669752379'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`id_user\` int NOT NULL AUTO_INCREMENT, \`first_name_user\` varchar(40) NOT NULL, \`last_name_user\` varchar(40) NOT NULL, \`number_user\` varchar(30) NOT NULL, \`cpf_user\` varchar(20) NOT NULL, \`email_user\` text NOT NULL, \`adressIdId\` int NULL, UNIQUE INDEX \`REL_a176a088dde3889f5d495d9a9d\` (\`adressIdId\`), PRIMARY KEY (\`id_user\`)) ENGINE=InnoDB`);
